...
fvector_table:$NL$$NL$
$TAB$ .word$TAB$ 0xFFFFFFFF $TAB$ ; エンディアン選択レジスタS(0xFFFFFF80)$NL$
$TAB$ .space$TAB$ 0x04$NL$
$TAB$ .word$TAB$ 0xFFFFFFFF $TAB$ ; オプション機能選択レジスタ1(0xFFFFFF88)$NL$
$TAB$ .word$TAB$ 0xE003A001 $TAB$ ; オプション機能選択レジスタ0(0xFFFFFF8C)$NL$
$TAB$ .space$TAB$ 0x0c$NL$
